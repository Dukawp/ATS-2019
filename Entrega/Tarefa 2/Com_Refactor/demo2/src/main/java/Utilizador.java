...
public class Utilizador implements Serializable {
    ...
    public Utilizador(Utilizador outroUser){
        this.nome = outroUser.nome;
        this.nif = outroUser.nif;
        this.email = outroUser.email;
        this.password = outroUser.password;
        this.morada = outroUser.morada;
        this.dataNascimento = outroUser.dataNascimento;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.nome.equals(user.nome) && this.nif.equals(user.nif) && this.email.equals(user.email)
            && this.password.equals(user.password) && this.morada.equals(user.morada)
            && this.dataNascimento.equals(user.dataNascimento);
    }
