...
public class Cliente extends Utilizador implements Classificação{
    ...
    public Cliente(Cliente outroCli){
        ...
        this.classificacao = outroCli.classificacao;
        this.nAlugueres = outroCli.nAlugueres;
        this.nKM = outroCli.nKM;
    }
    ...
    *****************************************************************************/
    ...
    public boolean equals(Object obj){
        ...
        return  super.equals(cli) && this.posicao.equals(cli.getPosicao()) &&
                this.classificacao == cli.classificacao && this.nAlugueres == cli.nAlugueres &&
                this.nKM == cli.nKM;
