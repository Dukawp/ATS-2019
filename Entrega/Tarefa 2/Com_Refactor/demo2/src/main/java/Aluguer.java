...
public class Aluguer implements Serializable {
     ...
     */
    private Aluguer(Aluguer outroAluguer){
        this.mail = outroAluguer.mail;
        this.matricula = outroAluguer.matricula;
        this.dataInicio = outroAluguer.dataInicio;
        this.dataFim = outroAluguer.dataFim;
        this.custoViagem = outroAluguer.custoViagem;
        this.tempoAteVeiculo = outroAluguer.tempoAteVeiculo;
        this.tempoViagem = outroAluguer.tempoViagem;
        this.destino = outroAluguer.destino;
        this.distancia = outroAluguer.distancia;
        this.aceite = outroAluguer.aceite;
        this.listaEspera = outroAluguer.listaEspera;
        this.realizado = outroAluguer.realizado;
        this.altPrice = outroAluguer.altPrice;
        this.estadoClassif = outroAluguer.estadoClassif;
    }
     ...
     */
    private int getTempoAteVeiculo(){return this.tempoAteVeiculo;}
    
    /**
     * Devolve o tempo (em segundos) total da viagem.
     * @return int Representa o tempo total da viagem.
     */
    private int getTempoViagem(){return this.tempoViagem;}
    ...
    public boolean equals(Object obj) {
        ...
        return auxEquals(alug);
    }

    private boolean auxEquals(Aluguer alug) {
        return  this.mail.equals(alug.mail) && this.matricula.equals(alug.matricula) &&
                this.dataInicio.equals(alug.dataInicio) && this.dataFim.equals(alug.dataFim) &&
                this.custoViagem == alug.custoViagem && this.tempoAteVeiculo == alug.tempoAteVeiculo &&
                this.tempoViagem == alug.tempoViagem && this.aceite == alug.aceite &&
                this.listaEspera == alug.listaEspera && this.realizado == alug.realizado &&
                this.altPrice == alug.altPrice && this.estadoClassif == alug.estadoClassif;
    }
