...
public class ParDatas implements Serializable {
    ...
    /** Construtor por omissão. É criada uma instância da classe ParDatas. */
    public ParDatas(){
    ...
    public boolean isAvailable(ParDatas dataPedido){
        ...
        return (!this.dataInicio.before(dataPedidoI) || !this.dataFim.after(dataPedidoF)) && (!this.dataInicio.before(dataPedidoI) || !this.dataFim.after(dataPedidoI)) && (!dataPedidoI.before(this.dataInicio) || !dataPedidoF.before(this.dataFim));
    }
