...
public class Veiculo implements Serializable, Classificação{
    ...
    public Veiculo(Veiculo outroVeiculo){
        this.marca = outroVeiculo.marca;
        this.matricula = outroVeiculo.matricula;
        this.nif = outroVeiculo.nif;
        this.velocidade = outroVeiculo.velocidade;
        this.preco = outroVeiculo.preco;
        this.consumo = outroVeiculo.consumo;
        this.autonomia = outroVeiculo.autonomia;
        this.posicao = outroVeiculo.posicao;
        this.disponivel = outroVeiculo.disponivel;
        this.classificacao = outroVeiculo.classificacao;
    ...
    public int tempoAteVeiculoPé(Coordinate posicaoCli, Weather weath){
        ...
        return Integer.valueOf((int) tempo);
    }
    ...
    public int tempoViagemCarro(Coordinate destino, Weather weath){
        ...
        return Integer.valueOf((int) tempoMin);
    }
    ...
    public void abastecerVeiculo(double quantidade){
        ...
        BigDecimal autonomiaInicial = BigDecimal.valueOf(this.autonomia);
        BigDecimal consumo = BigDecimal.valueOf(this.consumo);
    ...
    public boolean verificaAutonomia(int val1, int val2){
        return this.autonomia >= val1 && this.autonomia <= val2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.marca.equals(veiculo.marca) && this.matricula.equals(veiculo.matricula) &&
               this.nif.equals(veiculo.nif) && this.velocidade == veiculo.velocidade &&
               this.preco == veiculo.preco && this.consumo == veiculo.consumo &&
               this.autonomia == veiculo.autonomia && this.posicao.equals(veiculo.posicao) &&
               this.disponivel == veiculo.disponivel && this.classificacao == veiculo.classificacao;
    }
