...
public class ParDatas implements Serializable {
    ...
    public ParDatas(ParDatas outroPar){
        this.dataInicio = outroPar.dataInicio;
        this.dataFim = outroPar.dataFim;
    }
    ...
    public boolean isAvailable(ParDatas dataPedido){
        GregorianCalendar dataPedidoI = dataPedido.dataInicio;
        GregorianCalendar dataPedidoF = dataPedido.dataFim;
    ...
    public boolean equals(Object obj) {
        ...
        return this.dataInicio.equals(date.dataInicio) && this.dataFim.equals(date.dataFim);
    }
