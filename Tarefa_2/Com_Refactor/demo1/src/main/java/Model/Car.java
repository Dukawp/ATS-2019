...
public class Car implements Serializable {
    ...
    boolean hasRange(Point dest) {
        if(this.range / this.fullTankRange < 0.1) return false;
    ...
    public String warnings() {
        ...
        if(this.range / this.fullTankRange < 0.15)
    ...
    private boolean equalAux(Car car) {
    ...
    public String toString() {
        return new StringBuilder()
                .append(this.numberPlate).append("\n")
                .append(String.format("%.2f", this.range)).append("\n")
                .append(String.format("%.2f", this.basePrice)).append("\n")
